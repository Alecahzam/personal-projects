    ...
    <div><NavBar />
      <div className= "AboutUs">
        ...
        <p>
          ...
          stack application from start to finish completely on my own. Music is
          one of my greatest passions, so I was very excited to begin working on
          this, and being able to listen to my very own website while I code it
          is quite the uplifting experience. I drew great inspiration from
          SoundCloud and other music streaming sites without trying to make a
          clone of them.
          <div>
            {" "}
            ...
            always open to making new connections and seizing oppurtunities, so if you'd like to reach out
